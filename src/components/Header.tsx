  ...
  return (
    <header className="sticky top-0 z-50 bg-white shadow-sm">
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2">
          <div className="flex items-center gap-6">
            ...
            <a
              ...
              className="hover:text-[#fc0527] transition-colors hidden sm:inline"
            >
              {contact.email}
            </a>
          </div>
      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4">
        <Link href="/" className="shrink-0 rounded-sm bg-neutral-900 px-3 py-2">
          <Image
            src={SITE.logo}
            alt={SITE.name}
        ...
        <nav className="lg:hidden border-t border-neutral-100 bg-white px-4 py-4">
          {NAV_LINKS.map((link) => (
            <div key={link.label} className="border-b border-neutral-100 py-2">
              <Link
                href={link.href}
                className="block font-semibold uppercase text-sm py-1"
